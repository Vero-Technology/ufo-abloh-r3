...
# step 1: put the package manager on PATH, for your own lifecycle scripts. From ci.yml::ci, which runs `pnpm install`
corepack enable

# step 2: dependencies, from your lockfile. From ci.yml::ci, which runs `pnpm install`
